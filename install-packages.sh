...
&& curl -o $HOME/.extras https://raw.githubusercontent.com/therenanlira/my-environment/refs/heads/main/.extras
...
&& curl -o $HOME/.kafka-tools https://raw.githubusercontent.com/therenanlira/my-environment/refs/heads/main/.kafka-tools
